...
class App {
    ...
    createUsersList() {
        const usersList = document.querySelector('.select-user') as HTMLDivElement;
    ...
    handleSubmit(e: SubmitEvent) {
        ...
        this.usedElements.commentsCounter.innerHTML = `<span class="comments-superscript">Комментарии</span> ${!this.commentID ? '(0)' : `(${this.commentID})`}`;
...
class Commentary {
    ...
    handleAddToFavorite() {
        ...
        this.isFavorite ? heartImg.src = './img/heart.svg' : heartImg.src = './img/likeHeart-not-filled.svg';
